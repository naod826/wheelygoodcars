        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    @auth
                        <li class="nav-item"><a class="nav-link text-light" href="{{ route('my-cars.index') }}">Mijn aanbod</a></li>
                        <li class="nav-item"><a class="nav-link text-light" href="{{ route('my-cars.create.step1') }}">Aanbod plaatsen</a></li>
                    @endauth
                </ul>
                <ul class="navbar-nav">
                    @guest
